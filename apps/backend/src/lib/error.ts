...
export function InterceptPrismaError(error: unknown): never {
  ...
  if (prismaValidationError) {
    throw new PrismaFlowError({
      ...
      reason:
        'Gönderilen bilgiler kontrol edilemedi. Lütfen alanları gözden geçirip tekrar deneyin.',
    });
  }
    ...
    switch (prismaCode) {
      ...
      case 'P1001':
        errorResult = {
          ...
          reason:
            'Şu anda hizmete ulaşılamıyor. Lütfen biraz sonra tekrar deneyin.',
          status: 503,
        };
        break;
      ...
      case 'P1011':
        errorResult = {
          error: 'Bağlantı sorunu',
          reason:
            'Güvenli bağlantı kurulamadı. Lütfen biraz sonra tekrar deneyin.',
          status: 503,
        };
        break;
      ...
      case 'P2019':
        errorResult = {
          error: 'Geçersiz istek',
          reason:
            'İstek işlenemedi. Lütfen alanları kontrol edip tekrar deneyin.',
          status: 400,
        };
        break;
      ...
      case 'P2034':
        errorResult = {
          ...
          reason:
            'İşlem sırasında geçici bir çakışma oluştu. Lütfen tekrar deneyin.',
          status: 503,
        };
        break;
      ...
      case 'P2037':
        errorResult = {
          error: 'Sistem yoğun',
          reason:
            'Şu anda yoğunluk nedeniyle işlem tamamlanamadı. Lütfen tekrar deneyin.',
          status: 503,
        };
        break;
